...
### Put a single datastream record into the datastream2 index

```

POST /datastream2/_doc
{
  "version": 1,
  "streamId": "12345",
  "cp": "123456",
  "reqId": "1239f220",
  "reqTimeSec": "1681926067.171",
  "bytes": "4995",
  "cliIP": "128.147.28.68",
  "statusCode": "206",
  "proto": "HTTPS",
...
### Get a record with a specific ID out of an index

```
GET datastream2/_doc/LeehmocB6jpTIpvhE9rK
```
